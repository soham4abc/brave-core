...
export const getUIMessages = (): Record<string, string> => {
  const strings = [
    ...
    'backupWalletTitle',
    'bat',
    'batNotAllowedForUserLearnMore',
    'batNotAllowedForUserNotification',
    'batNotAllowedForUserTitle',
    'blockedUserLearnMore',
    'blockedUserNotification',
    'blockedUserTitle',
    'pendingUserLearnMore',
    'pendingUserNotification',
    'pendingUserTitle',
    'restrictedUserLearnMore',
    'restrictedUserNotification',
    'restrictedUserTitle',
    'unverifiedUserLearnMore',
