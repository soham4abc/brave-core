...
TEST_F(
  ...
  GetAds()->GetAccountStatement(
      [](const bool success, const StatementInfo& statement) {
        ...
        TransactionInfo uncleared_transaction_1;
        ...
        TransactionInfo uncleared_transaction_2;
        ...
        TransactionInfo uncleared_transaction_3;
        ...
        TransactionInfo uncleared_transaction_4;
