...
#ifndef BRAVELEDGER_ENDPOINT_PROMOTION_GET_WALLET_GET_WALLET_H_
#define BRAVELEDGER_ENDPOINT_PROMOTION_GET_WALLET_GET_WALLET_H_
...
#endif  // BRAVELEDGER_ENDPOINT_PROMOTION_GET_WALLET_GET_WALLET_H_
